...
var (
	...
	Base16Black   = newColorOption("", "base16.colors.black", "#FF0000", "Base16 black source color")
	...
	Base16Red     = newColorOption("", "base16.colors.red", "#222222", "Base16 red source color")
