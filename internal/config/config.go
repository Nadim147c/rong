...
var (
	...
	Base16Black   = newColorOption("", "base16.color.black", "#FF0000", "Black source color for base16")
	Base16Blue    = newColorOption("", "base16.color.blue", "#0000FF", "Blue source color for base16")
	Base16Cyan    = newColorOption("", "base16.color.cyan", "#5555FF", "Cyan source color for base16")
	Base16Green   = newColorOption("", "base16.color.green", "#00FF00", "Green source color for base16")
	Base16Magenta = newColorOption("", "base16.color.magenta", "#FF00FF", "Magenta source color for base16")
	Base16Red     = newColorOption("", "base16.color.red", "#222222", "Red source color for base16")
	Base16White   = newColorOption("", "base16.color.white", "#EEEEEE", "White source color for base16")
	Base16Yellow  = newColorOption("", "base16.color.yellow", "#FFFF00", "Yellow source color for base16")
)
